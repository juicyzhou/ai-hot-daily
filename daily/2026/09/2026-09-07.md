...
> 共 7 条精选 · 统计时段 2026-09-07 07:30 ~ 2026-09-08 07:30（北京时间）
...
4. **Cognition 完成超 20 亿美元 E 轮融资，估值达 480 亿美元** — Cognition 模型 / Devin 博客（网页）（9/8 00:00）
...
## 技巧与观点
5. **GPT-6 Astra爆火后，卡兹克谈执行能力贬值与判断力断层** — 公众号：数字生命卡兹克（9/7 08:08）
...
6. **Anthropic 发布 Claude Platform 降本指南并更新 claude-api 技能** — Claude：Blog（网页）（9/8 00:00）
...
7. **Tomer Tunguz 解析 AI 消耗的三波浪潮：从聊天到智能体再到 meta-harness** — Tomer Tunguz 博客（VC 分析）（9/7 08:00）
