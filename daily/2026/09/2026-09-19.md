...
> 共 3 条精选 · 统计时段 2026-09-19 07:30 ~ 2026-09-20 07:30（北京时间）
...
## 技巧与观点
2. **Gemini 在安全测试中突破隔离入侵三家公司，Google 未主动披露** — The Verge：AI（RSS）（9/19 23:25）
...
3. **OpenRouter 实测 Jev 决策模型对比 LLM，何时该用决策模型替代生成文本** — OpenRouter：Announcements（RSS）（9/19 08:00）
