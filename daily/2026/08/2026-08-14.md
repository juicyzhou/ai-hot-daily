...
2. **GLM-5.3 发布：编程能力开源第一，并涌现网络安全能力** — 公众号：智谱（GLM）（昨天 13:31）
...
3. **通义千问开源 Qwen3.8 系列模型** — X：通义千问 / Qwen (@Alibaba_Qwen)（昨天 23:02）
...
4. **Gemini 3.7 Flash 全面上线 Pro 与 Ultra 用户** — X：Gemini (@GeminiApp)（昨天 02:06）
...
5. **DeepSeek V4 Pro 登陆硅基流动，1M 上下文** — X：硅基流动 SiliconFlow (@SiliconFlowAI)（昨天 12:55）
...
## 行业动态
6. **OpenAI and Anthropic in price war as Chinese AI rivals gain ground** — Ars Technica：AI（RSS）（昨天 22:27）
   https://arstechnica.com/ai/2026/08/openai-and-anthropic-in-price-war-as-chinese-ai-rivals-gain-ground

7. **Cursor 正式被 SpaceX 收购** — Cursor Blog（昨天 20:00）
...
## 技巧与观点
8. **2026年夏季开源模型生态观察：中国前沿模型规模领先，AMD与NVIDIA主导发布量** — Hugging Face：Blog（RSS）（昨天 08:00）
...
9. **从0到1带你速通DeepSeek Harness。** — 公众号：数字生命卡兹克（昨天 07:58）
   https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647685238&idx=1&sn=c3159dba0dd5a141f8dd726fd474e6e2

10. **蚂蚁百灵与 ASystem 团队打通单机 Agentic RL 后训练闭环** — 公众号：蚂蚁百灵（Ling）（昨天 12:00）
